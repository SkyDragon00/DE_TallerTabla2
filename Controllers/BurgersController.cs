...
namespace DE_TallerTabla2.Controllers
{
    public class BurgersController : Controller
    {
        ...
        public BurgersController(DE_TallerTabla2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'DE_TallerTabla2Context.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DE_TallerTabla2Context.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
